            ...
            <div class="row">
                <div class="col-12">
                    <div class="faq-content" data-aos="fade-up" data-aos-delay="0">
                        <h5 class="title">Below are frequently asked questions
                    ...
                    <div class="col-12">
                        <div class="faq-accordian">
                            <div class="faq-accordian-single-item" data-aos="fade-up" data-aos-delay="0">
                                ...
                                <label for="item-1">Is the item in good condition?
                                </label>
                                <div class="item-content">
                                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laudantium perspiciatis expedita dolorem molestiae consequatur exercitationem obcaecati. Dolore facere eveniet est nobis officiis amet accusantium obcaecati, temporibus perferendis soluta, non fuga.</p>
                                </div>
                            </div>
                            <div class="faq-accordian-single-item" data-aos="fade-up" data-aos-delay="200">
                                <input id="item-2" name="accordian-item" type="radio">
                                <label for="item-2">How do I cancel an order?
                                </label>
                                <div class="item-content">
                            ...
                            <div class="faq-accordian-single-item" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <label for="item-3">Is there a discount?
                                </label>
                                <div class="item-content">
                                    <p>Donec mattis finibus elit ut tristique. Nullam tempus nunc eget arcu vulputate,
                                        eu porttitor tellus commodo. Aliquam erat volutpat. Aliquam consectetur lorem eu
                                ...
                                <div class="product-details-gallery-area mb-7">
                                    ...
                                    <div
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="product-image-thumb-single swiper-slide">
                                                <img class="img-fluid"
                                                    src="images/product/default/home-1/default-2.jpg" alt="">
                                            </div>
                                            <div class="product-image-thumb-single swiper-slide">
                                                <img class="img-fluid"
                                                    src="images/product/default/home-1/default-3.jpg" alt="">
                                            </div>
                                            <div class="product-image-thumb-single swiper-slide">
                                                <img class="img-fluid"
                                                    src="images/product/default/home-1/default-4.jpg" alt="">
                                            </div>
                                            <div class="product-image-thumb-single swiper-slide">
                                                <img class="img-fluid"
                                                    src="images/product/default/home-1/default-5.jpg" alt="">
                                            </div>
                                            <div class="product-image-thumb-single swiper-slide">
                                                <img class="img-fluid"
                                                    src="images/product/default/home-1/default-6.jpg" alt="">
                                            </div>
                                        </div>
                                        <!-- Add Arrows -->
