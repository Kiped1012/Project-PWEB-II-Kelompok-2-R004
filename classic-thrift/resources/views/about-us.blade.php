                ...
                <div class="col-md-6">
                    <div class="about-img" data-aos="fade-up" data-aos-delay="0">
                        <div class="img-responsive">
                            <img src="images/about/bj.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="content" data-aos="fade-up" data-aos-delay="200">
                        <h3 class="title">ABOUT OUR ClassicThrift</h3>
                        <h5 class="semi-title">Find hidden treasures!:>
                        </h5>
                        <p>Our thrift website is a great place to find clothing, accessories, and other unique items at affordable prices. We offer a wide range of carefully curated second-hand goods, from vintage brands to modern designers.bBy buying second-hand, you reduce the demand for new products, which helps reduce waste and pollution.
                        </p>
                    </div>
                </div>
            </div>
