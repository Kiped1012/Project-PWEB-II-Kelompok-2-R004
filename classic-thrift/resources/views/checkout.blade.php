                        ...
                        <form action="#">
                            ...
                            <div class="order_table table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td> Cheap Clothes <strong> × 2</strong></td>
                                            <td> Rp. 5</td>
                                        </tr>
                                        <tr>
                                            <td> Cheap Clothes <strong> × 2</strong></td>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <th>Shipping</th>
                                            <td><strong>Rp. 4</strong></td>
                                        </tr>
                                        <tr class="order_total">
                                            <th>Order Total</th>
                                            <td><strong>Rp. 10</strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                            <div class="payment_method">
                                ...
                                <div class="panel-default">
                                    ...
                                    <div id="methodPaypal" class="collapse " data-parent="#methodPaypal">
                                        <div class="card-body1">
                                            <p>Pay via Dana; you can pay with your credit card if you don’t have a
                                                Dana account.</p>
                                        </div>
                                    </div>
                                </div>
